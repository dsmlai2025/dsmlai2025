...
- **Databases & Querying:** Google BigQuery, ![MySQL](https://img.shields.io/badge/mysql-4479A1.svg?style=for-the-badge&logo=mysql&logoColor=white), ![Postgres](https://img.shields.io/badge/postgres-%23316192.svg?style=for-the-badge&logo=postgresql&logoColor=white)  
...
- **Development & Collaboration:** ![Jupyter Notebook](https://img.shields.io/badge/jupyter-%23FA0F00.svg?style=for-the-badge&logo=jupyter&logoColor=white), ![GitHub](https://img.shields.io/badge/github-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)  
- **Other Tools:** ![Microsoft Excel](https://img.shields.io/badge/Microsoft_Excel-217346?style=for-the-badge&logo=microsoft-excel&logoColor=white)  

<!-- Example to add images/logos next to tools (optional) -->
<!--
Google BigQuery  
![MySQL](path/to/mysql-logo.png) MySQL  
-->
...
**Project:** In this project I built a monetization model for a post-revenue B2B SaaS business, and then modify it for a different pricing scheme.
I was provided with a description of the company, its product, pricing scheme, and a dataset of recent months' activity. 
Based on this model, I came up with product improvements that can improve monetization KPIs as well as suggest a change to the pricing scheme. Finally I modified the original models to accommodate a given modified pricing scheme.
